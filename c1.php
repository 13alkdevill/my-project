...
<body>
  ...
  <div class="row">
    <div class="main">
      ...
      <img src="/com11.PNG" width="250" height="150">
      <p></p>
      <h2 style="color: black">ราคา : 15,000 บาท</h2>
...
function mFunction() {
  alert("BUY SUCCESS");
    ...
    <div class="main">
      <h1>lenovo-laptop-ideapad</h1>
      <p></p>
      <p>ด้วยประสิทธิภาพที่พร้อมจะทำให้ท่านรับมือกับทุกงานได้อย่างราบรื่น กับรูปลักษณ์สุดหรูด้วยการเลือกใช้อะลูมิเนียม ทำให้ Ideapad 720S (15) เป็นโน้ตบุ๊กที่พร้อมสำหรับทุกการใช้งาน รวมถึงด้านความบันเทิง<span id="dots">...</span><span id="more">และยังไม่ลืมด้านความปลอดภัยด้วยเซ็นเซอร์สแกนลายนิ้วมืออันชาญฉลาดที่พร้อมให้ท่านใช้งานได้ในยามที่ต้องการ</span></p>
  ...
  <div class="row">
    <div class="column">
      <img src="c1.jpg" style="width: 100%" onclick="openModal();currentSlide(3)" class="hover-shadow cursor">
    </div>
    <div class="column">
      <img src="c2.jpg" style="width: 100%" onclick="openModal();currentSlide(3)" class="hover-shadow cursor">
    </div>
    <div class="column">
      <img src="c3.jpg" style="width: 100%" onclick="openModal();currentSlide(3)" class="hover-shadow cursor">
    </div>
    <div class="column">
      <img src="c4.jpg" style="width: 100%" onclick="openModal();currentSlide(3)" class="hover-shadow cursor">
    </div>
