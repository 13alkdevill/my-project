...
<body>
  ...
  <div class="row">
    <div class="main">
      ...
      <p></p>
      <h2 style="color: black">ราคา : 7,000 บาท</h2>
...
function mFunction() {
  alert("BUY SUCCESS");
    ...
    <div class="main">
      <h1>XL2411P 144Hz 24 inch e-Sports MONITOR</h1>
      <p></p>
      <p>ZOWIE’s XL-series features the premiere e-Sports monitors for PC competitors, fine-tuned to guarantee the smoothest and responsive experience, and the clearest images to arm you for competition.</p>
  ...
  <div class="row">
    <div class="column">
      <img src="/m1.PNG" style="width: 100%" onclick="openModal();currentSlide(3)" class="hover-shadow cursor">
    </div>
    <div class="column">
      <img src="/m2.PNG" style="width: 100%" onclick="openModal();currentSlide(3)" class="hover-shadow cursor">
    </div>
    <div class="column">
      <img src="/m3.PNG" style="width: 100%" onclick="openModal();currentSlide(3)" class="hover-shadow cursor">
    </div>
    <div class="column">
      <img src="/m4.PNG" style="width: 100%" onclick="openModal();currentSlide(3)" class="hover-shadow cursor">
    </div>
