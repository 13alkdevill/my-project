...
function mFunction() {
  alert("BUY SUCCESS");
    ...
    <div class="main">
      <h1>mainboard-msi-z370-gaming</h1>
      <p></p>
...
GAMING CERTIFIED: 24-hour on- and offline game and motherboard testing by eSports players..</span></p>
  ...
  <div class="row">
    <div class="column">
      <img src="/ma1.PNG" style="width: 100%" onclick="openModal();currentSlide(3)" class="hover-shadow cursor">
    </div>
    <div class="column">
      <img src="/ma2.PNG" style="width: 100%" onclick="openModal();currentSlide(3)" class="hover-shadow cursor">
    </div>
    <div class="column">
      <img src="/ma3.PNG" style="width: 100%" onclick="openModal();currentSlide(3)" class="hover-shadow cursor">
    </div>
    <div class="column">
      <img src="/ma4.PNG" style="width: 100%" onclick="openModal();currentSlide(3)" class="hover-shadow cursor">
    </div>
