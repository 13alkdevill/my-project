...
<body>
  ...
  <div class="row">
    <div class="main">
      ...
      <p></p>
      <h2 style="color: black">ราคา : 9,990 บาท</h2>
...
GAMING CERTIFIED: 24-hour on- and offline game and motherboard testing by eSports players..</span></p>
  ...
  <div class="row">
    <div class="column">
      <img src="/gt1.PNG" style="width: 100%" onclick="openModal();currentSlide(3)" class="hover-shadow cursor">
    </div>
    <div class="column">
      <img src="/g111.jpg"" style="width: 100%" onclick="openModal();currentSlide(3)" class="hover-shadow cursor">
    </div>
    <div class="column">
      <img src="/gt3.jpg"" style="width: 100%" onclick="openModal();currentSlide(3)" class="hover-shadow cursor">
    </div>
    <div class="column">
      <img src="/gt4.jpg"" style="width: 100%" onclick="openModal();currentSlide(3)" class="hover-shadow cursor">
    </div>
