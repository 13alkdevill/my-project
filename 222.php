...
?>
<form action="de.php" name="frmAdd" method="post">
<table width="284" border="1">
  ...
  <tr>
    ...
    <td style="color:black"><input type="text" name="txtLast" size="20" value="<?php echo $_SESSION['last_name'];?>"></td>
    </tr>
  <tr>
    <th style="color:black" width="120">add</th>
    <td style="color:black"><input type="text" name="txtPhone" size="2" value="<?php echo $_SESSION['adds'];?>"></td>
    </tr>
  <tr>
    <th  style="color:black" width="120">tel</th>
    <td style="color:black"><input type="text" name="txtAdd" size="5" value="<?php echo $_SESSION['tels'];?>"></td>
    </tr>
